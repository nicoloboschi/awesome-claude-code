...
- [Container Use](https://github.com/dagger/container-use) by [dagger](https://github.com/dagger) - Development environments for coding agents.
- [Hindsight](https://github.com/vectorize-io/hindsight) by [Vectorize](https://github.com/vectorize-io) - State-of-the-art long-term memory for AI agents. Installs as a Claude Code skill to give persistent memory across sessions via retain/recall/reflect operations. Supports local mode (fully self-hosted with embedded DB) and cloud mode for team-shared memory. Open source and MIT-licensed. Enable multiple agents to work safely and independently with your preferred stack.
